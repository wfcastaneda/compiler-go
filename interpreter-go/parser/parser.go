...
func New(l *lexer.Lexer) *Parser {
	...
	// Map TokenTypes to prefix parse fn's
...
func (p *Parser) parseArrayLiteral() ast.Expression {
	...
	array.Elements = p.parseExpresssionList(token.RBRACKET)
...
func (p *Parser) parseCallExpression(function ast.Expression) ast.Expression {
	...
	exp.Arguments = p.parseExpresssionList(token.RPAREN)
	return exp
}
...
// Helper to check parser.curToken precedence
...
// Helper to check parser.peekToken precedence
